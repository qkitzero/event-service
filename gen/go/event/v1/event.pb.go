...
var file_event_v1_event_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x13, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x76,
	...
	0x6e, 0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x32, 0xcd, 0x01, 0x0a, 0x0c, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x60, 0x0a, 0x0b, 0x43,
	...
	0x01, 0x2a, 0x22, 0x09, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x5b, 0x0a,
...
var file_event_v1_event_proto_depIdxs = []int32{
	5, // 0: event.v1.Event.start_time:type_name -> google.protobuf.Timestamp
	5, // 1: event.v1.Event.end_time:type_name -> google.protobuf.Timestamp
	5, // 2: event.v1.CreateEventRequest.start_time:type_name -> google.protobuf.Timestamp
	5, // 3: event.v1.CreateEventRequest.end_time:type_name -> google.protobuf.Timestamp
	0, // 4: event.v1.ListEventsResponse.events:type_name -> event.v1.Event
	1, // 5: event.v1.EventService.CreateEvent:input_type -> event.v1.CreateEventRequest
	3, // 6: event.v1.EventService.ListEvents:input_type -> event.v1.ListEventsRequest
	2, // 7: event.v1.EventService.CreateEvent:output_type -> event.v1.CreateEventResponse
	4, // 8: event.v1.EventService.ListEvents:output_type -> event.v1.ListEventsResponse
